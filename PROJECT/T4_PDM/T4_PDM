...
-- Query 4
SELECT CONCAT(C.T4_CUST_ID,",",T4_CUST_FNAME,T4_CUST_LNAME) AS CUST_INFO FROM (((T4_CUSTOMER C INNER JOIN T4_VEHICLE V ON
 (C.T4_CUST_ID=V.T4_CUST_ID) ) INNER JOIN T4_PREMIUM_PAYMENT P ON (P.T4_CUST_ID=V.T4_CUST_ID AND P.T4_PREMIUM_PAYMENT_AMOUNT=0)) 
 INNER JOIN T4_INCIDENT_REPORT IR ON (IR.T4_CUST_ID=P.T4_CUST_ID AND IR.T4_INCIDENT_TYPE='ACCIDENT'))
...
-- Query 6
SELECT CONCAT(C.T4_CUST_ID,",",T4_CUST_FNAME,",",T4_CUST_LNAME) AS CUST_INFO FROM (T4_CUSTOMER C INNER JOIN T4_CLAIM_SETTLEMENT CS 
ON CS.T4_CUST_ID=C.T4_CUST_ID
